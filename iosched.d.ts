...
declare module "iosched" {
   ...
   */
  function event(method: number, fd: number, callback: Function, errback?: Function, arg?: any): object;
   ...
   * @param arg {Any} Argument, saved in this ioevent.arg property.
   */
  function event(method: number, fd: number, callback: Function, arg?: any): object;
   ...
   */
  function select(timeout: number): Array<number>;
  function select(fdsUser: object, timeout: number): Array<number>;
   ...
   * @param timeout {Integer} Wait timeout in milliseconds. default: undefined means wait forever.
   */
  export function forever(timeout: number): Array<number>;
