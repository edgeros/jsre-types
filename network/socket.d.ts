...
declare module "socket" {
   ...
   *
   * @param domain {number} Protocol domain.
   * @param type {number} Protocol type.
   ...
   *
   * @param sockFd {number} Socket file descriptor.
   */
   ...
   * @param timeout {number} Synchronous connection time to wait in milliseconds, default: undefined means timeout with default connect timeout setting.
   */
   ...
   * @param {number} timeout timeout in milliseconds. default: undefined means wait forever.
   */
  ...
  function send(sockFd: number, buff: Buffer[], timeout?: number): number;
  ...
  function sendto(sockFd: number, remoteAddr: SockAddr, buffer: Buffer[], timeout?: number): number;
   ...
   * @param offset {number} Buffer offset. default:0.
   * @param length {number} Receive length limit. default:buffer.length.
   * @param {number} timeout timeout in milliseconds. default: undefined means wait forever.
   */
   ...
   * @param idle {number} The time (in seconds) the connection needs to remain idle before TCP starts sending keepalive probes. If enable is true, must have this parameter.
   * @param interval {number} The time (in seconds) between individual keepalive probes. default: idle.
   * @param count {number} The maximum number of keepalive probes TCP should send before dropping the connection. default: 3.
   */
